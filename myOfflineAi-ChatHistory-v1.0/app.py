#----------------------
# myOfflineAi-ChatHistory (Includes agent chat histories - saved locally in conversations.json)
# Creator: vbookshelf
...
<head>
    ...
    <title>myOfflineAi-ChatHistory</title>
